...
export default function COC2Page() {
  ...
  const modules = [
    ...
    },
    {
      ...
      duration: '10 hours',
      videoUrl: 'https://www.youtube.com/watch?v=7_-qWlvQQtY',
    ...
    },
    {
      ...
      duration: '8 hours',
      videoUrl: 'https://www.youtube.com/watch?v=AMXIE5c5sv8',
                ...
                <div id={`video-modal-${module.id}`} className="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                  <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                    <div className="p-6">
                      ...
                      <div className="mt-6">
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Module Description</h4>
                ...
                <div id={`practice-modal-${module.id}`} className="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                  <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                    <div className="p-6">
                      ...
                      {/* Module 1 Specific Content */}
                      {module.id === 'module1' && (
                        <div className="space-y-6">
                          <div className="bg-green-50 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">Objectives:</h4>
                            <p className="text-green-800">Understand different network types and topology configurations</p>
                          </div>
                          ...
                          <div>
                            ...
                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                              <li>Study different network types (LAN, WAN, PAN, MAN)</li>
                              <li>Analyze network topology diagrams</li>
                              <li>Identify network components and their functions</li>
                              <li>Practice network design principles</li>
                              <li>Document network architecture</li>
                            </ol>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Local Area Networks (LAN)</h5>
                                <p className="text-sm text-gray-600 mb-2">Network that connects computers within a limited area</p>
                                <div>
                              ...
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Wide Area Networks (WAN)</h5>
                                <p className="text-sm text-gray-600 mb-2">Network that covers larger geographical areas</p>
                                <div>
                                  <span className="text-xs font-medium text-gray-500">Examples:</span>
                                  <ul className="text-xs text-gray-600 mt-1">
                                    <li>• Internet</li>
                                    <li>• Corporate network across cities</li>
                                  </ul>
                                </div>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Personal Area Networks (PAN)</h5>
                                <p className="text-sm text-gray-600 mb-2">Network based on individual workspace</p>
                                <div>
                                  <span className="text-xs font-medium text-gray-500">Examples:</span>
                                  <ul className="text-xs text-gray-600 mt-1">
                              ...
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Metropolitan Area Networks (MAN)</h5>
                                <p className="text-sm text-gray-600 mb-2">Network stretching across metropolitan areas</p>
                                <div>
                                  <span className="text-xs font-medium text-gray-500">Examples:</span>
                                  <ul className="text-xs text-gray-600 mt-1">
                                    <li>• City-wide network</li>
                                    <li>• University campus network</li>
                                  </ul>
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                              <div className="bg-blue-50 rounded-lg p-4">
                                <h5 className="font-semibold text-blue-900 mb-2">Star Topology</h5>
                                <p className="text-sm text-blue-800 mb-3">Central node connects to each computer independently</p>
                                <div className="grid grid-cols-2 gap-3">
                                  ...
                                  <div>
                                    ...
                                    <ul className="text-xs text-blue-600 mt-1">
                                      <li>• Requires many cables</li>
                                      <li>• Central point failure</li>
                                    </ul>
                                  </div>
                                </div>
                              </div>
                              <div className="bg-blue-50 rounded-lg p-4">
                                <h5 className="font-semibold text-blue-900 mb-2">Bus Topology</h5>
                                <p className="text-sm text-blue-800 mb-3">Single cable connects all computers</p>
                                <div className="grid grid-cols-2 gap-3">
                                  <div>
                                    <span className="text-xs font-medium text-blue-700">Advantages:</span>
                                    <ul className="text-xs text-blue-600 mt-1">
                                      <li>• Less cabling required</li>
                                      <li>• Simple setup</li>
                                    </ul>
                                  </div>
                                  <div>
                              ...
                              <div className="bg-blue-50 rounded-lg p-4">
                                <h5 className="font-semibold text-blue-900 mb-2">Ring Topology</h5>
                                <p className="text-sm text-blue-800 mb-3">Computers connected in a circular pattern</p>
                                <div className="grid grid-cols-2 gap-3">
                                  <div>
                                    <span className="text-xs font-medium text-blue-700">Advantages:</span>
                                    <ul className="text-xs text-blue-600 mt-1">
                                      <li>• Equal access to network</li>
                                  ...
                                  <div>
                                    <span className="text-xs font-medium text-blue-700">Disadvantages:</span>
                                    <ul className="text-xs text-blue-600 mt-1">
                                      <li>• Single failure affects all</li>
                                      <li>• Difficult to expand</li>
                                    </ul>
                                  </div>
                                </div>
                              </div>
                              <div className="bg-blue-50 rounded-lg p-4">
                                <h5 className="font-semibold text-blue-900 mb-2">Mesh Topology</h5>
                                <p className="text-sm text-blue-800 mb-3">All nodes interconnected with each other</p>
                                <div className="grid grid-cols-2 gap-3">
                                  <div>
                                    <span className="text-xs font-medium text-blue-700">Advantages:</span>
                                    <ul className="text-xs text-blue-600 mt-1">
                      ...
                      {/* Module 2 Specific Content */}
                      {module.id === 'module2' && (
                        <div className="space-y-6">
                          <div className="bg-green-50 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">Objectives:</h4>
                            <p className="text-green-800">Create cable connection using UTP cable with specific standard tools and materials in accordance to cable color coding</p>
                          </div>
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900 mb-3">Step-by-Step Procedures:</h4>
                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                              <li>Get a UTP cable and crimp both ends using crimping tools and RJ45</li>
                              <li>Perform color coding T-568A</li>
                              <li>Test the cable using LAN cable tester</li>
                            </ol>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Unshielded Twisted Pair (UTP)</h5>
                                <p className="text-sm text-gray-600 mb-2">Copper cabling with twisted pairs without shielding</p>
                                <div className="mb-2">
                                  <span className="text-xs font-medium text-gray-500">Categories:</span>
                                  <p className="text-xs text-gray-600 mt-1">Cat5e, Cat6, Cat6a, Cat7</p>
                                </div>
                                <div>
                              ...
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Shielded Twisted Pair (STP)</h5>
                                <p className="text-sm text-gray-600 mb-2">Copper cabling with additional shielding</p>
                                <div className="mb-2">
                              ...
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Coaxial Cable</h5>
                                <p className="text-sm text-gray-600 mb-2">Cable with inner conductor surrounded by concentric shield</p>
                                <div>
                                  <span className="text-xs font-medium text-gray-500">Uses:</span>
                                  <ul className="text-xs text-gray-600 mt-1">
                                    <li>• Cable TV</li>
                                    <li>• Internet connections</li>
                                    <li>• Video transmission</li>
                                  </ul>
                                </div>
                              </div>
                              <div className="bg-gray-50 rounded-lg p-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Fiber Optic Cable</h5>
                                <p className="text-sm text-gray-600 mb-2">Cable containing optical fibers for light transmission</p>
                                <div className="mb-2">
                                  <span className="text-xs font-medium text-gray-500">Advantages:</span>
                                  <ul className="text-xs text-gray-600 mt-1">
                                    <li>• High speed</li>
                          ...
                          <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                              <div className="bg-yellow-50 rounded-lg p-4">
                                <h5 className="font-semibold text-yellow-900 mb-3">T-568A Standard</h5>
                                <div className="space-y-2">
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-yellow-800 mr-2">Pair 1:</span>
                                    <span className="text-yellow-700">White/Green - Green</span>
                                  </div>
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-yellow-800 mr-2">Pair 2:</span>
                                    <span className="text-yellow-700">White/Orange - Blue</span>
                                  </div>
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-yellow-800 mr-2">Pair 3:</span>
                                    <span className="text-yellow-700">White/Blue - Orange</span>
                                  </div>
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-yellow-800 mr-2">Pair 4:</span>
                                    <span className="text-yellow-700">White/Brown - Brown</span>
                                  </div>
                                </div>
                              </div>
                              <div className="bg-blue-50 rounded-lg p-4">
                                <h5 className="font-semibold text-blue-900 mb-3">T-568B Standard</h5>
                                <div className="space-y-2">
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-blue-800 mr-2">Pair 1:</span>
                                    <span className="text-blue-700">White/Orange - Orange</span>
                                  </div>
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-blue-800 mr-2">Pair 2:</span>
                                    <span className="text-blue-700">White/Green - Blue</span>
                                  </div>
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-blue-800 mr-2">Pair 3:</span>
                                    <span className="text-blue-700">White/Blue - Green</span>
                                  </div>
                                  <div className="flex items-center text-sm">
                                    <span className="font-medium text-blue-800 mr-2">Pair 4:</span>
                                    <span className="text-blue-700">White/Brown - Brown</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div>
                            ...
                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                              <li>Strip cable jacket to expose 4 twisted pairs</li>
                              <li>Untwist pairs and arrange according to T-568A standard</li>
                              <li>Trim wires to uniform length</li>
                              <li>Insert wires into RJ45 connector</li>
                              <li>Crimp connector using crimping tool</li>
                              <li>Test cable with LAN tester</li>
                            </ol>
                          </div>
                        </div>
                      )}
                      ...
                      {module.id === 'module3' && (
                        <div className="space-y-6">
                          <div className="bg-green-50 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">Objectives:</h4>
                            <p className="text-green-800">Set up network configuration and configure IP addressing for network devices</p>
                          </div>
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900 mb-3">Step-by-Step Procedures:</h4>
                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                              <li>Configure network interface settings</li>
                              <li>Set up static IP addressing</li>
                              <li>Configure subnet mask and gateway</li>
                          ...
                          <div className="bg-blue-50 rounded-lg p-4">
                            <h4 className="font-semibold text-blue-900 mb-2">Static IP Configuration Setup</h4>
                            <p className="text-blue-800 mb-3">Manual IP address assignment for network devices</p>
                            
                            <div className="mb-4">
                              <h5 className="font-medium text-blue-900 mb-2">Network Setup:</h5>
                              <div className="grid md:grid-cols-2 gap-3 text-sm">
                                <div className="bg-white rounded p-2">
                                  <span className="font-medium text-blue-800">Server:</span>
                                  <div className="text-blue-700">IP: 10.0.0.100</div>
                                  <div className="text-blue-700">Subnet: 255.255.255.0</div>
                                  <div className="text-blue-700">Gateway: 10.0.0.1</div>
                                </div>
                                <div className="bg-white rounded p-2">
                                  <span className="font-medium text-blue-800">Laptop:</span>
                                  <div className="text-blue-700">IP: 10.0.0.101</div>
                                  <div className="text-blue-700">Subnet: 255.255.255.0</div>
                                  <div className="text-blue-700">Gateway: 10.0.0.1</div>
                                </div>
                                <div className="bg-white rounded p-2">
                                  <span className="font-medium text-blue-800">Desktop 1:</span>
                                  <div className="text-blue-700">IP: 10.0.0.102</div>
                                  <div className="text-blue-700">Subnet: 255.255.255.0</div>
                                  <div className="text-blue-700">Gateway: 10.0.0.1</div>
                                </div>
                                <div className="bg-white rounded p-2">
                                  <span className="font-medium text-blue-800">Desktop 2:</span>
                                  <div className="text-blue-700">IP: 10.0.0.103</div>
                                  <div className="text-blue-700">Subnet: 255.255.255.0</div>
                                  <div className="text-blue-700">Gateway: 10.0.0.1</div>
                                </div>
                              </div>
                            ...
                            <div className="space-y-4">
                              <div>
                                <h6 className="font-medium text-blue-900 mb-2">IP Configuration Steps:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-blue-700">
                                  <li>Press Windows + R, type &quot;ncpa.cpl&quot; and press enter</li>
                                  <li>Right-click Ethernet connection and select Properties</li>
                                  <li>Select &quot;Internet Protocol Version 4 (TCP/IPv4)&quot; and click Properties</li>
                                  <li>Check &quot;Use the following IP Address&quot;</li>
                                  <li>Enter the assigned IP address for your device</li>
                                  <li>Enter Subnet Mask: 255.255.255.0</li>
                                  <li>Enter Default Gateway: 10.0.0.1</li>
                                  <li>Click OK to save settings</li>
                                </ol>
                              </div>

                              <div>
                                <h6 className="font-medium text-blue-900 mb-2">Firewall Configuration:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-blue-700">
                                  <li>Press Windows + R, type &quot;control firewall.cpl&quot; and press enter</li>
                                  <li>Turn OFF Windows Defender Firewall for Private, Public, and Domain networks</li>
                                  <li>Click OK to save changes</li>
                                </ol>
                              </div>

                              <div>
                                <h6 className="font-medium text-blue-900 mb-2">Network Sharing Setup:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-blue-700">
                                  <li>Press Windows + R, type &quot;control.exe /name Microsoft.NetworkAndSharingCenter&quot;</li>
                                  <li>Click &quot;Change advanced sharing settings&quot;</li>
                                  <li>Turn ON Network Discovery</li>
                                  <li>Turn ON File and Printer Sharing</li>
                                  <li>Turn OFF Password Protected Sharing</li>
                                  <li>Click &quot;Save Changes&quot;</li>
                                </ol>
                              </div>

                              <div>
                                <h6 className="font-medium text-blue-900 mb-2">Required Services:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-blue-700">
                                  <li>Press Windows + R, type &quot;services.msc&quot; and press enter</li>
                                  <li>Right-click each service, set Startup Type to Automatic and Start the service:</li>
                                  <li>• Functional Discovery Resource Publication</li>
                              ...
                              <div>
                                <h6 className="font-medium text-blue-900 mb-2">Connectivity Testing:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-blue-700">
                                  <li>Press Windows + R, type &quot;cmd&quot; and press enter</li>
                                  <li>Type &quot;ping [IP_ADDRESS] -t&quot; to test connectivity</li>
                                  <li>Example: ping 10.0.0.101 -t</li>
                                </ol>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="bg-green-50 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">Dynamic IP Configuration Setup</h4>
                            <p className="text-green-800 mb-3">Automatic IP address assignment using DHCP</p>
                            
                            <div className="space-y-4">
                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Router Configuration:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Turn ON network router and connect via LAN cable</li>
                                  <li>Hold RESET button for 5 seconds until power LED blinks</li>
                                  <li>Check gateway IP: Press Windows + R, type &quot;ncpa.cpl&quot;</li>
                                  <li>Right-click Ethernet, click Status, click Details</li>
                                  <li>Look for IPv4 Default Gateway (e.g., 192.168.0.1)</li>
                                  <li>Open web browser and type the gateway IP</li>
                                  <li>Login with default credentials (admin/admin)</li>
                                </ol>
                              </div>

                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Wireless Settings:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Go to Wireless Menu</li>
                                  <li>Change Wireless Network Name to Lastname.Firstname</li>
                                  <li>Go to Wireless Security</li>
                                  <li>Under WPA/WPA2, change Wireless Password to 123456789</li>
                                </ol>
                              </div>

                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Client Configuration:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Press Windows + R, type &quot;ncpa.cpl&quot; and press enter</li>
                                  <li>Right-click Ethernet connection and select Properties</li>
                                  <li>Select &quot;Internet Protocol Version 4 (TCP/IPv4)&quot; and click Properties</li>
                                  <li>Check &quot;Obtain an IP address automatically&quot;</li>
                                  <li>Check &quot;Obtain DNS server address automatically&quot;</li>
                                  <li>Click OK to save settings</li>
                                </ol>
                              </div>

                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Firewall Configuration:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Press Windows + R, type &quot;control firewall.cpl&quot; and press enter</li>
                                  <li>Turn OFF Windows Defender Firewall for Private, Public, and Domain networks</li>
                                  <li>Click OK to save changes</li>
                              ...
                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Network Sharing Setup:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Press Windows + R, type &quot;control.exe /name Microsoft.NetworkAndSharingCenter&quot;</li>
                                  <li>Click &quot;Change advanced sharing settings&quot;</li>
                                  <li>Turn ON Network Discovery</li>
                              ...
                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Required Services:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Press Windows + R, type &quot;services.msc&quot; and press enter</li>
                                  <li>Right-click each service, set Startup Type to Automatic and Start the service:</li>
                                  <li>• Functional Discovery Resource Publication</li>
                              ...
                              <div>
                                <h6 className="font-medium text-green-900 mb-2">Connectivity Testing:</h6>
                                <ol className="list-decimal list-inside space-y-1 text-sm text-green-700">
                                  <li>Press Windows + R, type &quot;cmd&quot; and press enter</li>
                                  <li>Type &quot;ping [IP_ADDRESS] -t&quot; to test connectivity</li>
                                  <li>Example: ping 192.168.0.101 -t</li>
                                </ol>
                              </div>
                            </div>
                          </div>
                      ...
                      {/* Module 4 Specific Content */}
                      {module.id === 'module4' && (
                        <div className="space-y-6">
                          <div className="bg-green-50 rounded-lg p-4">
                            <h4 className="font-semibold text-green-900 mb-2">Objectives:</h4>
                            <p className="text-green-800">Configure routers and wireless access points for network connectivity</p>
                          </div>
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900 mb-3">Step-by-Step Procedures:</h4>
                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                              <li>Connect router to internet source</li>
                              <li>Access router configuration interface</li>
                              <li>Configure basic network settings</li>
                              <li>Set up wireless network</li>
                              <li>Configure security settings</li>
                              <li>Test wireless connectivity</li>
                            </ol>
                          </div>
                          ...
                          <div>
                            ...
                            <ol className="list-decimal list-inside space-y-2 text-gray-700">
                              <li>Connect router to modem using Ethernet cable</li>
                              <li>Power on router and wait for initialization</li>
                              <li>Access router admin interface (usually 192.168.1.1 or 192.168.0.1)</li>
                              <li>Login with default credentials (check router manual)</li>
                              <li>Configure WAN settings for internet connection</li>
                              <li>Set up LAN network settings</li>
                              <li>Configure DHCP server settings</li>
                              <li>Set up wireless network name (SSID)</li>
                              <li>Configure wireless security (WPA2/WPA3)</li>
                          ...
                          <div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                              <div className="bg-green-50 rounded-lg p-4">
                                <h5 className="font-semibold text-green-900 mb-2">WPA2 (Wi-Fi Protected Access 2)</h5>
                                <p className="text-sm text-green-800 mb-2">Strong encryption for wireless networks</p>
                                <div className="mb-2">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-green-600 mt-1">Choose WPA2-PSK and set strong password</p>
                                </div>
                              </div>
                              <div className="bg-green-50 rounded-lg p-4">
                                <h5 className="font-semibold text-green-900 mb-2">WPA3 (Wi-Fi Protected Access 3)</h5>
                                <p className="text-sm text-green-800 mb-2">Latest wireless security standard</p>
                                <div className="mb-2">
                                  <span className="text-xs font-medium text-green-700">Advantages:</span>
                                  <ul className="text-xs text-green-600 mt-1">
                                ...
                                <div>
                                  <span className="text-xs font-medium text-green-700">Setup:</span>
                                  <p className="text-xs text-green-600 mt-1">Choose WPA3-SAE if supported by devices</p>
                                </div>
                              </div>
                            </div>
                          </div>
